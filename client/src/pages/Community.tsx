...
import { getExperiences, voteOnExperience, getUserVoteForExperience, deleteExperience, type Experience } from "@/api/experiences"
...
export function Community() {
  ...
  useEffect(() => {
    ...
    const fetchExperiences = async () => {
      try {
        console.log('Community: About to call getExperiences()')
        const response = await getExperiences() as any
        console.log('Community: getExperiences response:', response)
