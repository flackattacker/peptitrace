  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.log("PeptideDetail component: Setting peptide data:", (peptideData as any).peptide || (peptideData as any).data?.peptide)
        setPeptide((peptideData as any).peptide || (peptideData as any).data?.peptide)

        const experiencesArray = (experiencesData as any).experiences || (experiencesData as any).data?.experiences || []
